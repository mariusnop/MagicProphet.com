...
MagicProphet is public on the web at [magicprophet.com](https://magicprophet.com) since `v1.0.8` on 2026-09-11. The iOS and Android apps follow once the stores have released them.
...
Every release since, and what it changed, is listed on [What's new](https://magicprophet.com/en/changelog).

Before this, MagicProphet ran as an invite-only private beta from 2026-04-14, up to version `v1.0.7`.
...
- `v1.0.0-beta.X` to `v1.0.7`: private beta builds
- `v1.0.8`: first public release, on the web, 2026-09-11
- `v1.Y.Z` after that: a new minor version brings something new, a patch fixes what was there
